        ...
        <div class="card-body">
            <form action="{{ route('pages.update', ['page'=>$page->id]) }}" method="POST" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="submit" value="Salvar" class="btn bg-gradient-success">
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    tinymce.init({
        ...
        height:300,
        menubar:false,
        plugins:['link', 'table', 'image', 'autoresize', 'lists', 'charmap', 'searchreplace', 'advlist', 'spellchecker'],
        toolbar:'charmap | undo redo | formatselect |bold italic strikethrough underline forecolor backcolor | alignleft aligncenter alignright alignjustify | table | link image | bullist numlist | searchreplace',
        content_css:[
